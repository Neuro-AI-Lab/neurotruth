...
class SensorBatchCodecTest {
    ...
    fun `maps every declared sensor path to an upload channel`() {
        ...
        assertEquals(SensorChannel.HR, SensorBatchCodec.channelFor("/sensor/hr"))
        assertEquals(SensorChannel.PPG_GREEN, SensorBatchCodec.channelFor("/sensor/ppg"))
        assertEquals(SensorChannel.PPG_IR, SensorBatchCodec.channelFor("/sensor/ppg_ir"))
        assertEquals(SensorChannel.PPG_RED, SensorBatchCodec.channelFor("/sensor/ppg_red"))
        assertEquals(SensorChannel.EDA, SensorBatchCodec.channelFor("/sensor/eda"))
        assertEquals(SensorChannel.ACCEL_X, SensorBatchCodec.channelFor("/sensor/accel_x"))
        assertEquals(SensorChannel.ACCEL_Y, SensorBatchCodec.channelFor("/sensor/accel_y"))
        assertEquals(SensorChannel.ACCEL_Z, SensorBatchCodec.channelFor("/sensor/accel_z"))
        assertEquals(SensorChannel.SKIN_TEMP, SensorBatchCodec.channelFor("/sensor/skin_temp"))
    }
