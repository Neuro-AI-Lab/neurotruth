...
- All accepted success, quality-failure, and technical-failure videos remain AES-256-GCM encrypted until audited deletion. `RPPG_ENABLED=false` is the default and the feature is not release-ready before joint phone/DGX validation.
